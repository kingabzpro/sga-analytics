          ...
          <div className="flex flex-wrap items-center justify-end gap-2">
            {onReaudit ? (
              <button
                ...
                className="cursor-pointer rounded-xl bg-white px-4 py-2.5 text-sm font-semibold text-teal-700 ring-1 ring-teal-200 transition hover:bg-teal-50 disabled:cursor-not-allowed disabled:opacity-50"
              >
                Re-audit &amp; compare
              </button>
            ) : null}
